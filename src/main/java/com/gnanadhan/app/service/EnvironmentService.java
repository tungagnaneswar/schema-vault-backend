...
import com.gnanadhan.app.dto.EnvironmentRequest;
...
import com.gnanadhan.app.mapper.EnvironmentMapper;
...
public class EnvironmentService {
    ...
    public EnvironmentResponse createEnvironment(EnvironmentRequest request) {
        ...
        log.info("User {} created environment '{}' (ID: {}) in project ID: {}", user.getEmail(), saved.getName(), saved.getId(), project.getId());
    ...
    public void deleteEnvironment(Long id) {
        ...
        User user = currentUserService.getCurrentUser();
        log.info("User {} deleted environment ID: {} from project ID: {}", user.getEmail(), id, env.getProject().getId());
    }
}
