...
import com.gnanadhan.app.util.ClientIpUtil;
...
public class AuthController {
    ...
    public ResponseEntity<Map<String, String>> register(@Valid @RequestBody RegisterRequest registerRequest, HttpServletRequest servletRequest) {
        requireAnonymous();
    ...
    public ResponseEntity<Map<String, String>> resendVerificationOtp(@Valid @RequestBody ResendOtpRequest request, HttpServletRequest servletRequest) {
        requireAnonymous();
        String clientIp = ClientIpUtil.getClientIp(servletRequest);
    ...
    public ResponseEntity<AuthResponse> verifyRegistration(@Valid @RequestBody VerifyOtpRequest verifyRequest, HttpServletRequest servletRequest, HttpServletResponse response) {
        requireAnonymous();
        String clientIp = ClientIpUtil.getClientIp(servletRequest);
    ...
    @PostMapping("/refresh")
    public ResponseEntity<AuthResponse> refreshToken(@RequestBody(required = false) TokenRefreshRequest request, HttpServletRequest servletRequest, HttpServletResponse response) {
    ...
    @PostMapping("/logout")
    public ResponseEntity<Map<String, String>> logout(@RequestBody(required = false) TokenRefreshRequest request, HttpServletRequest servletRequest, HttpServletResponse response) {
        String token = extractRefreshToken(request, servletRequest);
        if (token != null) {
    ...
    public ResponseEntity<Map<String, String>> verifyOtp(@Valid @RequestBody VerifyOtpRequest request, HttpServletRequest servletRequest) {
        String clientIp = ClientIpUtil.getClientIp(servletRequest);
