...
import com.schemavault.app.dto.CreateTeamMemberRequest;
import com.schemavault.app.dto.MemberProjectRequest;
import com.schemavault.app.dto.TeamDbConnectionRequest;
import com.schemavault.app.dto.TeamMemberRequest;
import com.schemavault.app.dto.TeamRequest;
import com.schemavault.app.dto.TeamResponse;
import com.schemavault.app.service.TeamService;
...
public class TeamController {
    ...
    public ResponseEntity<?> updateMemberRole(@PathVariable Long id, @PathVariable Long userId,
            @Valid @RequestBody com.schemavault.app.dto.UpdateTeamRoleRequest request) {
    ...
    public ResponseEntity<List<Map<String, Object>>> getMemberProjects(@PathVariable Long id,
            @PathVariable Long userId) {
        return ResponseEntity.ok(teamService.getMemberProjects(id, userId));
    }

    @PostMapping("/{id}/members/{userId}/projects")
    public ResponseEntity<?> assignProjectToMember(@PathVariable Long id, @PathVariable Long userId,
            @Valid @RequestBody MemberProjectRequest request) {
    ...
    public ResponseEntity<?> removeProjectFromMember(@PathVariable Long id, @PathVariable Long userId,
    ...
    public ResponseEntity<?> addDbConnectionToTeam(@PathVariable Long id,
            @Valid @RequestBody TeamDbConnectionRequest request) {
