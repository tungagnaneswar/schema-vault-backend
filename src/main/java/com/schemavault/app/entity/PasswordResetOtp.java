 ...
 * Security invariants:
 * <ul>
 * <li>The plain OTP value is <b>never</b> stored here; only its BCrypt
 * hash.</li>
 * <li>The plain reset token is <b>never</b> logged; only stored as a UUID
 * string.</li>
 * <li>A record is considered active when {@code isUsed = false} and
 * {@code expiresAt} is in the future.</li>
 * <li>After 5 failed verification attempts ({@code attemptCount >= 5}), the
 * record is treated as locked.</li>
 * </ul>
 */
@Entity
