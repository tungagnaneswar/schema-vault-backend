...
/**
 * Periodically removes stale OTP records from the {@code password_reset_otps}
 * table.
 *
 * <p>
 * Two categories are purged:
 * <ol>
 * <li><b>Expired unused records</b> — OTPs that were never verified before
 * their TTL elapsed.
 * Removed immediately once the clock passes {@code expires_at}.</li>
 * <li><b>Used records past retention</b> — OTPs that completed a password reset
 * are kept
 * for {@value USED_RECORD_RETENTION_HOURS} hours for audit purposes, then
 * deleted.</li>
 * </ol>
 */
@Component
...
public class OtpCleanupScheduler {
    ...
    /**
     * How long (in hours) to retain used OTP records after a successful password
     * reset.
     * Keeping them briefly allows audit-log correlation; they must not accumulate
     * indefinitely.
     */
     ...
     *
     * <p>
     * Both deletes are issued in a single transaction so the table never ends up
