...
import com.schemavault.app.dto.UpdateTeamRoleRequest;
import com.schemavault.app.entity.DbConnection;
import com.schemavault.app.entity.MemberProjectAssignment;
...
import com.schemavault.app.entity.TeamRole;
...
import com.schemavault.app.mapper.TeamMapper;
import com.schemavault.app.repository.DbConnectionRepository;
import com.schemavault.app.repository.MemberProjectAssignmentRepository;
...
public class TeamService {
    ...
    public void addDbConnectionToTeam(Long teamId, TeamDbConnectionRequest request) {
        ...
        if (reqPermission == null || (!reqPermission.equals("READ") && !reqPermission.equals("WRITE")
                && !reqPermission.equals("ADMIN"))) {
        ...
        if (!"ADMIN".equals(userDbPermission)) {
            throw new UnauthorizedException(
                    "You must have ADMIN access to this database connection to assign it to a team.");
        }
    ...
    public void assignProjectToMember(Long teamId, Long userId, MemberProjectRequest request) {
        ...
        TeamDbConnection teamDbConnection = teamDbConnectionRepository
                ...
                .orElseThrow(
                        () -> new IllegalArgumentException("Database connection must be assigned to the team first"));
