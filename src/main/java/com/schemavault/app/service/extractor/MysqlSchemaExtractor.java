...
public class MysqlSchemaExtractor implements SchemaExtractor {
    ...
    public SchemaModel extract(DbConnection connection, String decryptedPassword) {
        ...
        try (Connection conn = DriverManager.getConnection(url, connection.getUsername(), decryptedPassword)) {
            ...
            List<SequenceModel> sequences = Collections.emptyList(); // MySQL has AUTO_INCREMENT, no standalone
                                                                     // sequences
    ...
    private Map<String, List<ConstraintModel>> extractAllConstraints(Connection conn, String dbName)
            throws SQLException {
    ...
    private Map<String, List<ForeignKeyModel>> extractAllForeignKeys(Connection conn, String dbName)
            throws SQLException {
